...
% and convenient. You can readjust it to suit your tastes.
%
...
% students.
%
% The option twoha should be used if you are earning
...
% Bachelors students in the Schreyer Honors College & Engineering
% Science and two honors readers.
%\documentclass[bs,schreyer,esc,twoha,12pt]{psuthesis}
% Bachelors students in the Schreyer Honors College & Engineering Science.
% \documentclass[bs,schreyer,esc,12pt]{psuthesis}
% Bachelors students in Engineering Science.
% \documentclass[bs,esc,12pt]{psuthesis}

% The main font is defined here. You may, of course, use any
% other font that you like.
...
\usepackage{titlesec}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Removing the white space above chapter-type headings %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% I am frequently asked how to remove white space above chapter
% headings, which includes the Table of Contents, List of Figures,
% etc. Since the titlesec package is loaded above, the following
% code will set that space to 0pt. The default is 50pt. See the
% titlesec documentation for other options.
...
%%%%%%%%%%%%%%%%
% Title
\title{Dynamics of Fish, Crocodiles, Kangaroos, Turtles, Jellyfish, and Puppies}
...
\bachelorsdegreeinfo{for a baccalaureate degree \\ in Engineering
Science \\ with honors in Engineering Science}
...
\submittedto{The Schreyer Honors College}
...
\titleformat{\chapter}[display]{\fontsize{30}{30}\selectfont\bfseries\sffamily}{Chapter
\thechapter\hsp\textcolor{gray75}{\raisebox{3pt}{|}}}{0pt}{}{}
...
\allowdisplaybreaks{
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \appendix
  \titleformat{\chapter}[display]{\fontsize{30}{30}\selectfont\bfseries\sffamily}{Appendix
  \thechapter\textcolor{gray75}{\raisebox{3pt}{|}}}{0pt}{}{}
...
%\bibitem{Wisdom87} J. Wisdom, ``Rotational Dynamics of Irregularly
% Shaped Natural Satellites,'' \emph{The Astronomical Journal},
% Vol.~94, No.~5, 1987  pp. 1350--1360.

%\bibitem{G&H83} J. Guckenheimer and P. Holmes, \emph{Nonlinear
